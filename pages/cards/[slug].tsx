  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 space-y-6 transition-transform duration-300 hover:scale-[1.01]">
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-2">
              {card.contact.phone && (
                <a
                  ...
                  className="block text-blue-600 hover:bg-blue-100 hover:rounded-md px-2 py-1 transition"
                >
                  📞 {card.contact.phone}
                </a>
              )}
              ...
              {card.contact.whatsapp && (
                <a
                  ...
                  className="block text-green-600 hover:bg-green-100 hover:rounded-md px-2 py-1 transition"
                >
                  💬 WhatsApp
                </a>
              )}
            ...
            <div className="bg-gray-50 p-4 rounded-lg space-y-2">
              ...
              {card.socials.youtube && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block text-red-600 hover:bg-red-100 hover:rounded-md px-2 py-1 transition"
                >
                  ▶️ YouTube
                </a>
              )}
