    ...
    <>
      ...
      <main className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-8">
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 space-y-6">
          ...
          {/* Contact Section - Left inside box */}
          ...
          {/* Social Section - Left inside box */}
          <div className="space-y-2">
            <h2 className="text-lg font-semibold text-gray-800">Socials</h2>
            <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-left">
              {card.socials.facebook && (
                <a href={card.socials.facebook} target="_blank" rel="noopener noreferrer" className="block text-blue-600 hover:underline">
                  👍 Facebook
                </a>
              )}
              {card.socials.youtube && (
                <a href={card.socials.youtube} target="_blank" rel="noopener noreferrer" className="block text-red-600 hover:underline">
                  ▶️ YouTube
                </a>
              )}
            </div>
