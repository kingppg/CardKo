    ...
    <div style={cardWrapperStyle}>
      <div style={cardStyle}>
        ...
        <div style={contactSectionStyle}>
          ...
          <a href={`https://wa.me/${card.whatsapp.replace('+', '')}`} target="_blank" style={linkStyle}>💬 WhatsApp</a>
          <a href={card.facebook} target="_blank" style={linkStyle}>📘 Facebook</a>
          <a href={card.youtube} target="_blank" style={linkStyle}>▶️ YouTube</a>
        </div>
